...
def generate_launch_description():
    ...
    # Get parameters for the Servo (used internally by quest_teleop)
    ...
    # Note: Servo expects "planning_group_name" parameter (used by acceleration filter)
    ...
    # Quest Teleop Node (replaces servo_node_left and servo_node_right)
    # This node internally creates Servo instances and calls C++ API directly
    ...
    # Wait for joint states before starting quest_teleop
    required_joints = [
        "openarm_left_joint1",
        "openarm_left_joint2",
        "openarm_left_joint3",
