...
def generate_launch_description():
    ...
    # Use bimanual config (URDF needs both arms for complete TF tree)
    moveit_config = (
    ...
    # Get parameters for LEFT Servo only
    ...
    # Quest Teleop Node (LEFT arm only)
    ...
    # Wait for LEFT arm joint states only
    required_joints = [
        "openarm_left_joint1",
        "openarm_left_joint2",
        "openarm_left_joint3",
